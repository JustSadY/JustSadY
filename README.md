...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:Bunyo2402@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/justsady/)
...
```cpp
class BunyaminAlcin : public GameDeveloper
{
public:
    FString Name     = "Bünyamin Alçin";
    FString Alias    = "JustSadY";
    FString School   = "Nişantaşı University — Digital Game Design";
    FString Location = "Istanbul, Turkey 🇹🇷";
    FString Site     = "https://cv.justsady.uk";

    TArray<FString> Engines  = { "Unreal Engine (C++)", "Unity (C#)" };
    TArray<FString> Focus    = { "Combat Systems", "Open World", "Game AI", "Character Interactions" };
    TArray<FString> Passions = { "Music 🎵", "Coding 💻", "Learning 📚", "Gym 🏋️" };

    FString Motto() { return "Small steps lead to big achievements."; }
};
```
